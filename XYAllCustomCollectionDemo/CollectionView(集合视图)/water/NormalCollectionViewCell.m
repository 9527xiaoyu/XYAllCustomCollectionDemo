...
- (void)setModel:(PhotoModel *)model layout:(UICollectionViewLayout *)layout{
    ...
    WaterFlowLayout *currentLayout = (WaterFlowLayout *)layout;
    CGFloat width = [UIScreen mainScreen].bounds.size.width;
    CGFloat cellWidth = (width - (currentLayout.columnCount - 1) *currentLayout.minimumLineSpacing - currentLayout.sectionInset.left - currentLayout.sectionInset.right)/currentLayout.columnCount;
